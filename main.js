...
("scroll", () => {
  ...
  if(( homeHeight + aboutHeight + skillsHeight + workHeight/3  < window.scrollY)){
...
consoleText(['Hello World.', 'I\'m Kipack Jeong', 'A Software Developer.'], 'text',['white','#f5f5b9','lightblue']);
